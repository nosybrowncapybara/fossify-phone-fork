...
class RecentCallsAdapter(
    ...
    private var missedCallBackgroundColor = resources.getColor(R.color.color_missed_call_background)
    ...
    fun initDrawables() {
        ...
        missedCallBackgroundColor = resources.getColor(R.color.color_missed_call_background, theme)
    ...
    private inner class RecentCallViewHolder(val binding: ItemRecentCallBinding) : ViewHolder(binding.root) {
        fun bind(call: RecentCall) = bindView(
            ...
            binding.apply {
                val highlightMissed = call.isUnreturnedMissed
                if (highlightMissed) {
                    root.setBackgroundColor(missedCallBackgroundColor)
                } else {
                ...
                itemRecentsDateTime.apply {
                    ...
                    setTextColor(if (highlightMissed) missedCallColor else secondaryTextColor)
        ...
        return when {
            ...
            oldItem is RecentCall && newItem is RecentCall -> {
                oldItem.phoneNumber == newItem.phoneNumber &&
                        ...
                        oldItem.isUnreturnedMissed == newItem.isUnreturnedMissed &&
